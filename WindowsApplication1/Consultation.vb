Public Class Consultation
    ...
    Private Sub Consultation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: cette ligne de code charge les données dans la table 'BDDataSet.Consultation'. Vous pouvez la déplacer ou la supprimer selon vos besoins.
        Me.ConsultationTableAdapter.Fill(Me.BDDataSet.Consultation)

    End Sub

    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ConsultationBindingSource.AddNew()
        TextBox1.Text = ""
        TextBox2.Text = ""
        TextBox3.Text = ""
        TextBox4.Text = ""
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        Try
            ...
            Else
                ...
                ConsultationBindingSource.EndEdit()
                ConsultationTableAdapter.Update(BDDataSet.Consultation)
    ...
    Private Sub Button7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.Click
        Try
            If MessageBox.Show(" Vous Voulez Vraiment Supprimer Ce patient ", " Suprimer", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                ConsultationBindingSource.RemoveCurrent()
                ConsultationTableAdapter.Update(BDDataSet.Consultation)
    ...
    Private Sub CINToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CINToolStripButton.Click
        Try
            Me.ConsultationTableAdapter.CIN(Me.BDDataSet.Consultation, CINToolStripTextBox.Text)
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        Try
            Me.ConsultationTableAdapter.CIN(Me.BDDataSet.Consultation, TextBox20.Text)
        Catch ex As System.Exception
            System.Windows.Forms.MessageBox.Show(ex.Message)
        End Try
    End Sub
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ConsultationBindingSource.MoveFirst()
    End Sub

    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ConsultationBindingSource.MovePrevious()
    End Sub

    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ConsultationBindingSource.MoveNext()
    End Sub

    Private Sub Button8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.Click
        ConsultationBindingSource.MoveLast()
    End Sub
End Class